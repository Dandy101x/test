...
def perform_request(url: str, payload: dict, cookie: Optional[str]) -> Tuple[bool, str, float, str]:
...
def process_payloads(url: str, payloads: list, cookie: Optional[str], output_file: Optional[str], dbms: str, level: int, risk: int) -> None:
...
def get_db_name(url: str, cookie: Optional[str], dbms: str) -> Optional[str]:
...
def get_tables(url: str, cookie: Optional[str], dbms: str, db_name: str) -> Optional[list]:
...
def get_columns(url: str, cookie: Optional[str], dbms: str, db_name: str, table_name: str) -> Optional[list]:
...
def dump_data(url: str, cookie: Optional[str], dbms: str, db_name: str, table_name: str, column_name: str) -> Optional[list]:
